...
<div id="main">
	<form id="user-login-form" action="${url}/app/user/login-post.html" method="post">
		<div>
    ...
    <a class="register" onclick="openUserRegister(this)" data-url="${url}/app/user/register.html" tapmode="">立即注册</a>
